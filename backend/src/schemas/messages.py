...
class BaseMessageSafetyGuardResult(BaseModel):
    safety_guard_result: SafetyGuardResult | None = Field(default=None, description="Safety guard result including safety issues, blocked reason, and score")
    
class BaseMessageIPAddress(BaseModel):
    ip_address: str | None = Field(default=None, description="The IP address of the user who sent the message")
    
class Message(BaseMessage, BaseMessageParent, BaseMessageText, BaseMessageRecipe, BaseMessageTool, BaseMessageAIModel, BaseMessageSafetyGuardResult, BaseMessageIPAddress):
    """A message in a thread."""
    pass

class MessageResponse(BaseMessage, BaseMessageParent, BaseMessageText, BaseMessageRecipe, BaseMessageTool, BaseMessageAIModel):
...
class PaginatedMessages(BaseModel):
    ...
    messages: list[MessageResponse] = Field(description="The paginated list of messages for the current page")
...
class UpdateMessageParams(BaseMessageParent, BaseMessageText, BaseMessageTool, BaseMessageRecipe, BaseMessageAIModel, BaseMessageSafetyGuardResult, BaseMessageIPAddress):
    """Parameters for updating a message."""    
    id: str = Field(description="The message's id")
    updated_at: datetime = Field(description="When the message was last updated")


class CreateMessageParams(BaseMessageParent, BaseMessageText, BaseMessageTool, BaseMessageRecipe, BaseMessageAIModel, BaseMessageSafetyGuardResult, BaseMessageIPAddress):
