...
class BaseMessageIPAddressParams(BaseModel):
    """Base parameters for message operations with IP address fields."""
    ip_address: str | None = Field(default=None, description="The IP address of the user who sent the message")
    
    
class BaseMessageSafetyGuardResultParams(BaseModel):
    """Base parameters for message operations with safety guard result fields."""
    safety_guard_result: SafetyGuardResult | None = Field(default=None, description="Safety guard result including safety issues, blocked reason, and score")
...
class UpdateMessageParams(BaseMessageParentParams, BaseMessageTextParams, BaseMessageToolParams, BaseMessageRecipeParams, BaseMessageAIModelParams, BaseMessageSafetyGuardResultParams, BaseMessageIPAddressParams):
    """Parameters for updating a message."""    
    id: str = Field(description="The message's id")
    updated_at: datetime = Field(description="When the message was last updated")


class CreateMessageParams(BaseMessageParentParams, BaseMessageTextParams, BaseMessageToolParams, BaseMessageRecipeParams, BaseMessageAIModelParams, BaseMessageSafetyGuardResultParams, BaseMessageIPAddressParams):
