...
from services.chat_services.chat_session_handlers import ChatSessionHandlers, ChatSessionHandlersResult
...
class ChatSessionMessageProcessor:
    def __init__(
        ...
        on_message_processed: Callable[[MessageProcessingResult], Awaitable[None]] = None,
    ):
        ...
        self._event_handlers: dict[ConversationStreamEventName, Callable[..., Awaitable[ChatSessionHandlersResult]]] = {
