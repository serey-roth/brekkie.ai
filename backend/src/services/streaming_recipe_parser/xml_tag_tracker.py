...
class XMLTagTracker:
    ...
    def track(self, typ: str, tag: str, text: Optional[str], raw: str) -> Optional[list[Tuple[str, str]]]:
        """
    ...
    def _handle_end(self, tag, raw) -> Optional[list[Tuple[str, str]]]:
        ...
        for i in range(len(self.stack) - 1, -1, -1):
            if self.stack[i]["tag"] == tag:
                ...
                results = child_results + [(tag, completed["buffer"])] if tag in self.known_tags else child_results
