...
@pytest.fixture
def recipe_repository() -> RecipeRepository:
...
@pytest.fixture
def sample_recipe(recipe_id: str, user_id: str, thread_id: str) -> dict[str, Any]:
    ...
    return {
        ...
        "instructions": [
            RecipeInstruction(title="Test Instruction", description="Test Description")
        ],
...
class TestCreateRecipe:
    async def test_create_recipe(
        ...
        recipe_instructions = [
            RecipeInstruction.model_validate(inst) for inst in recipe.instructions
        ]
...
class TestGetRecipe:
    ...
    async def test_get_non_existent_recipe(
        self, async_session: AsyncSession, recipe_repository: RecipeRepository
    ) -> None:
...
class TestGetUserRecipes:
    @pytest_asyncio.fixture(scope="function")
    async def create_recipes_in_db(
        self,
        async_session: AsyncSession,
        recipe_repository: RecipeRepository,
        sample_recipe: dict[str, Any],
    ...
    async def test_get_non_existent_user_recipes(
        self, async_session: AsyncSession, recipe_repository: RecipeRepository
    ) -> None:
...
class TestUpdateRecipe:
    ...
    async def test_update_recipe(
        ...
        params = UpdateRecipeParams(
            ...
            ingredients=[
                ...
                RecipeIngredient(name="Updated Ingredient", quantity="2", unit="unit"),
            ],
            instructions=[
                sample_recipe["instructions"][0],
                RecipeInstruction(title="Updated Instruction", description="Updated Description"),
            ],
    ...
    async def test_update_recipe_with_none_values(
        self,
        async_session: AsyncSession,
        recipe_repository: RecipeRepository,
        create_recipe_in_db: None,
    ...
    async def test_update_recipe_complex_fields(
        self,
        async_session: AsyncSession,
        recipe_repository: RecipeRepository,
        create_recipe_in_db: None,
        ...
        new_ingredients = [
            RecipeIngredient(name="Updated Ingredient", quantity="2", unit="unit"),
            RecipeIngredient(name="Updated Ingredient 2", quantity="3", unit="unit"),
        ]
        params = UpdateRecipeParams(
            id=recipe_id,
            updated_at=datetime.now(timezone.utc),
...
class TestUpdateRecipeField:
    ...
    async def test_update_recipe_simple_string_field(
        self,
        async_session: AsyncSession,
        recipe_repository: RecipeRepository,
        create_recipe_in_db: None,
    ...
    async def test_update_recipe_simple_integer_field(
        self,
        async_session: AsyncSession,
        recipe_repository: RecipeRepository,
        create_recipe_in_db: None,
    ...
    async def test_update_invalid_field_payload(
        self,
        async_session: AsyncSession,
        recipe_repository: RecipeRepository,
        create_recipe_in_db: None,
    ...
    async def test_update_recipe_field_with_non_existent_recipe(
        self,
        async_session: AsyncSession,
        recipe_repository: RecipeRepository,
        create_recipe_in_db: None,
    ...
    async def test_override_recipe_ingredients(
        self,
        async_session: AsyncSession,
        recipe_repository: RecipeRepository,
        create_recipe_in_db: None,
        ...
        expected_ingredients = [
            RecipeIngredient(name="Updated Ingredient", quantity="2", unit="unit"),
            RecipeIngredient(name="Updated Ingredient 2", quantity="3", unit="unit"),
            RecipeIngredient(name="Updated Ingredient 3", quantity="4", unit="unit"),
        ]
...
class TestGetThreadRecipes:
    ...
    async def test_get_thread_recipes_with_non_existent_thread(
        self, async_session: AsyncSession, recipe_repository: RecipeRepository
    ) -> None:
        """Test retrieving recipes for non-existing thread returns empty list."""
        recipes = await recipe_repository.get_thread_recipes(
            async_session, "non-existing-thread-id"
        )
        assert len(recipes) == 0
...
class TestGetRecipesByMessageId:
    ...
    @pytest.fixture(scope="function")
    def sample_message(
        self, message_id: str, thread_id: str, recipe_id: str, user_id: str
    ) -> dict[str, Any]:
    ...
    async def create_message_in_db(
        self, async_session: AsyncSession, sample_message: dict[str, Any]
    ) -> None:
    ...
    async def test_get_recipes_by_message_ids(
        self,
        async_session: AsyncSession,
        recipe_repository: RecipeRepository,
        ...
        recipes = await recipe_repository.get_recipes_by_message_ids(async_session, [message_id])
        assert len(recipes) == 1
...
class TestCreateRecipes:
    @pytest_asyncio.fixture(scope="function")
    async def create_batch_recipes_in_db(
        self,
        async_session: AsyncSession,
        recipe_repository: RecipeRepository,
        sample_recipe: dict[str, Any],
