...
@pytest.fixture
def thread_repository() -> ThreadRepository:
    return ThreadRepository()


@pytest.fixture
def empty_thread_id() -> str:
    return "test-thread-id"


@pytest.fixture
def non_empty_thread_id() -> str:
...
class TestCreateThread:
    ...
    async def test_create_thread_with_optional_fields(
        self,
        async_session: AsyncSession,
        thread_repository: ThreadRepository,
        empty_thread_id: str,
...
@pytest.fixture
def sample_empty_thread(empty_thread_id: str, user_id: str) -> dict[str, Any]:
    return {
        "id": empty_thread_id,
        "user_id": user_id,
        "created_at": datetime.now(timezone.utc),
...
@pytest.fixture()
def sample_non_empty_thread(non_empty_thread_id: str, user_id: str) -> dict[str, Any]:
    return {
...
class TestGetThread:
    ...
    async def create_empty_thread_in_db(
        self,
        async_session: AsyncSession,
        thread_repository: ThreadRepository,
        sample_empty_thread: dict[str, Any],
    ) -> None:
    ...
    async def test_get_thread(
        ...
        async_session: AsyncSession,
        thread_repository: ThreadRepository,
        create_empty_thread_in_db: None,
        sample_empty_thread: dict[str, Any],
        empty_thread_id: str,
    ) -> None:
        ...
        assert cast(datetime, result.created_at) == strip_timezone(
            sample_empty_thread["created_at"]
        )
        assert cast(datetime, result.updated_at) == strip_timezone(
            sample_empty_thread["updated_at"]
        )
        assert result.is_empty is True

    async def test_get_non_existent_thread(
        self, async_session: AsyncSession, thread_repository: ThreadRepository
    ) -> None:
...
class TestGetUserThreads:
    ...
    def sample_user_threads(self, user_id: str) -> list[dict[str, Any]]:
        return [
            {
                "id": "test-thread-id-1",
                "user_id": user_id,
    ...
    @pytest_asyncio.fixture(scope="function")
    async def create_user_threads_in_db(
        self,
        async_session: AsyncSession,
        thread_repository: ThreadRepository,
        sample_user_threads: list[dict[str, Any]],
    ) -> None:
    ...
    async def test_get_user_threads(
        ...
        async_session: AsyncSession,
        thread_repository: ThreadRepository,
        create_user_threads_in_db: None,
        sample_user_threads: list[dict[str, Any]],
        user_id: str,
    ) -> None:
    ...
    async def test_exclude_empty_threads(
        self,
        async_session: AsyncSession,
        thread_repository: ThreadRepository,
        create_user_threads_in_db: None,
    ...
    async def test_from_timestamp_with_sort_by_created_at_asc(
        self,
        async_session: AsyncSession,
        thread_repository: ThreadRepository,
        create_user_threads_in_db: None,
        ...
        params = GetDBUserThreadsParams(
            user_id=user_id,
            sort_by="created_at",
            sort_order="asc",
            from_timestamp=sample_user_threads[0]["created_at"],
        )
    ...
    async def test_from_timestamp_with_sort_by_created_at_desc(
        self,
        async_session: AsyncSession,
        thread_repository: ThreadRepository,
        create_user_threads_in_db: None,
        ...
        params = GetDBUserThreadsParams(
            ...
            sort_by="created_at",
            sort_order="desc",
            from_timestamp=sample_user_threads[3]["created_at"],
        )
    ...
    async def test_from_timestamp_with_sort_by_updated_at_asc(
        self,
        async_session: AsyncSession,
        thread_repository: ThreadRepository,
        create_user_threads_in_db: None,
        ...
        params = GetDBUserThreadsParams(
            ...
            sort_by="updated_at",
            sort_order="asc",
            from_timestamp=sample_user_threads[0]["updated_at"],
        )
    ...
    async def test_from_timestamp_with_sort_by_updated_at_desc(
        self,
        async_session: AsyncSession,
        thread_repository: ThreadRepository,
        create_user_threads_in_db: None,
    ...
    async def test_from_timestamp_with_sort_by_created_at_asc_and_exclude_empty(
        self,
        async_session: AsyncSession,
        thread_repository: ThreadRepository,
        create_user_threads_in_db: None,
    ...
    async def test_from_timestamp_with_sort_by_created_at_asc_and_smaller_limit(
        self,
        async_session: AsyncSession,
        thread_repository: ThreadRepository,
        create_user_threads_in_db: None,
...
class TestUpdateThread:
    ...
    async def test_update_thread_with_none_values(
        self,
        async_session: AsyncSession,
        thread_repository: ThreadRepository,
        create_empty_thread_in_db: None,
    ...
    async def test_update_thread_with_non_existent_thread(
        self, async_session: AsyncSession, thread_repository: ThreadRepository
    ) -> None:
        params = UpdateThreadParams(
...
class TestCreateThreads:
    @pytest_asyncio.fixture(scope="function")
    async def create_batch_threads_in_db(
        self,
        async_session: AsyncSession,
        thread_repository: ThreadRepository,
        sample_user_threads: list[dict[str, Any]],
