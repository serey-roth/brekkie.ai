...
class TestChatSessionEngineState:
    ...
    def test_cleanup_timeout_task_with_running_task(self) -> None:
        session_ttl = 300
        state = ChatSessionEngineState(session_ttl)
    ...
    def test_cleanup_timeout_task_with_done_task(self) -> None:
        session_ttl = 300
        state = ChatSessionEngineState(session_ttl)
    ...
    def test_cleanup_timeout_task_with_no_task(self) -> None:
        session_ttl = 300
        state = ChatSessionEngineState(session_ttl)
    ...
    def test_is_timeout_task_running_with_running_task(self) -> None:
        session_ttl = 300
        state = ChatSessionEngineState(session_ttl)
    ...
    def test_is_timeout_task_running_with_done_task(self) -> None:
        session_ttl = 300
        state = ChatSessionEngineState(session_ttl)
    ...
    def test_is_timeout_task_running_with_no_task(self) -> None:
        session_ttl = 300
        state = ChatSessionEngineState(session_ttl)
