...
class TestHasMessageLimitReached:
    @pytest.mark.asyncio
    async def test_authenticated_user_below_limit(
        self, chat_session_limit_checker, mock_user_access_cache_service
    ):
    ...
    @pytest.mark.asyncio
    async def test_authenticated_user_at_limit(
        self, chat_session_limit_checker, mock_user_access_cache_service
    ):
        access_token = "test_token"
        user_access = UserAccess(
    ...
    @pytest.mark.asyncio
    async def test_authenticated_user_above_limit(
        self, chat_session_limit_checker, mock_user_access_cache_service
    ):
        access_token = "test_token"
        user_access = UserAccess(
    ...
    @pytest.mark.asyncio
    async def test_unauthenticated_user_below_limit(
        self, chat_session_limit_checker, mock_user_access_cache_service
    ):
        access_token = "test_token"
        user_access = UserAccess(
    ...
    @pytest.mark.asyncio
    async def test_unauthenticated_user_at_limit(
        self, chat_session_limit_checker, mock_user_access_cache_service
    ):
        access_token = "test_token"
        user_access = UserAccess(
    ...
    @pytest.mark.asyncio
    async def test_unauthenticated_user_above_limit(
        self, chat_session_limit_checker, mock_user_access_cache_service
    ):
        access_token = "test_token"
        user_access = UserAccess(
    ...
    @pytest.mark.asyncio
    async def test_access_token_not_found(
        self, chat_session_limit_checker, mock_user_access_cache_service
    ):
...
class TestGetMessageLimit:
    @pytest.mark.asyncio
    async def test_authenticated_user_limit(
        self, chat_session_limit_checker, mock_user_access_cache_service
    ):
        access_token = "test_token"
        user_access = UserAccess(
    ...
    @pytest.mark.asyncio
    async def test_unauthenticated_user_limit(
        self, chat_session_limit_checker, mock_user_access_cache_service
    ):
        access_token = "test_token"
        user_access = UserAccess(
    ...
    @pytest.mark.asyncio
    async def test_get_message_limit_access_token_not_found(
        self, chat_session_limit_checker, mock_user_access_cache_service
    ):
        access_token = "invalid_token"
        mock_user_access_cache_service.get_user_access.return_value = None
