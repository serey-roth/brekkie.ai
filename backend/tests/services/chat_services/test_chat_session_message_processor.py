...
@pytest.fixture
def mock_ai_food_agent() -> GoogleAIFoodAgent:
...
@pytest.fixture
def mock_on_message_processed() -> AsyncMock:
    return AsyncMock()
...
@pytest.fixture
def chat_session_message_processor(
...
@pytest.fixture
def sample_recipe_field() -> RecipeField:
    return RecipeField(name="name", value="Test Recipe")
...
class TestTextMessageChunkGenerated:
    ...
    @pytest.mark.asyncio
    async def test_text_message_chunk_generated_with_missing_assistant_message_id(
        self,
        mock_async_session: AsyncSession,
        chat_session_message_processor: ChatSessionMessageProcessor,
        mock_ai_food_agent: GoogleAIFoodAgent,
...
class TestTextMessageCompleted:
    ...
    @pytest.mark.asyncio
    async def test_missing_assistant_message_id_raises_value_error(
        self,
        mock_async_session: AsyncSession,
        chat_session_message_processor: ChatSessionMessageProcessor,
        mock_ai_food_agent: GoogleAIFoodAgent,
...
class TestAiAgentError:
    ...
    async def test_ai_agent_error(
        ...
        await chat_session_message_processor._handle_event(
            ...
            user_message_id=sample_user_message_id,
            event=ConversationStreamEvent(
                event="ai_agent_error", payload=AIAgentErrorPayload(error_message=error_message)
            ),
        )
