...
class TestCreateMessages:
    async def test_create_messages(
        self, async_session: AsyncSession, message_service: MessageService
    ) -> None:
        params: list[CreateMessageParams] = [
            CreateAssistantTextMessageParams(
...
class TestUpdateMessage:
    async def test_update_message(
        ...
        message = await message_service.create_assistant_text_message(
            async_session,
            CreateAssistantTextMessageParams(
                id="test-message-id",
                user_id="test-user-id",
        ...
        params = UpdateMessageParams(
            id="test-message-id",
            updated_at=datetime.now(timezone.utc),
            text_content_update=text_content_update,
        )
        ...
        assert message.id == params.id
        assert message.text_content == text_content_update.text_content
        assert message.updated_at == to_utc_isostring(params.updated_at)
...
class TestCountMessages:
    async def test_count_messages(
        ...
        for i in range(10):
            await message_service.create_assistant_text_message(
                async_session,
                CreateAssistantTextMessageParams(
                    id=f"test-message-id-{i}",
                    user_id="test-user-id",
        ...
        count = await message_service.count_messages(
            async_session, CountMessagesParams(thread_id="test-thread-id")
        )
        assert count == 10

    async def test_count_messages_by_user_id(
        self, async_session: AsyncSession, message_service: MessageService
    ) -> None:
        for i in range(10):
            await message_service.create_assistant_text_message(
        ...
        count = await message_service.count_messages(
            async_session, CountMessagesParams(thread_id="test-thread-id", user_id="test-user-id")
        )
        assert count == 10

    async def test_count_messages_by_role(
        self, async_session: AsyncSession, message_service: MessageService
    ) -> None:
        for i in range(10):
            await message_service.create_assistant_text_message(
        ...
        count = await message_service.count_messages(
            async_session,
            CountMessagesParams(thread_id="test-thread-id", role=MessageRole.assistant),
        )
        assert count == 10

        count = await message_service.count_messages(
            async_session, CountMessagesParams(thread_id="test-thread-id", role=MessageRole.user)
        )
        assert count == 0
...
class TestPaginatedMessages:
    @pytest.fixture()
    def assistant_text_message_params(self) -> list[CreateAssistantTextMessageParams]:
        return [
            CreateAssistantTextMessageParams(
                id=f"test-message-id-{i}",
                user_id="test-user-id",
    ...
    async def create_assistant_text_messages_in_db(
        self,
        async_session: AsyncSession,
        message_service: MessageService,
        assistant_text_message_params: list[CreateAssistantTextMessageParams],
    ) -> None:
    ...
    async def test_correct_return_type(
        ...
        async_session: AsyncSession,
        message_service: MessageService,
        create_assistant_text_messages_in_db: None,
        assistant_text_message_params: list[CreateAssistantTextMessageParams],
    ) -> None:
    ...
    async def test_get_paginated_messages_with_default_limit(
        self,
        async_session: AsyncSession,
        message_service: MessageService,
        create_assistant_text_messages_in_db: None,
    ...
    async def test_get_paginated_messages_with_sorted_by_created_at_asc(
        self,
        async_session: AsyncSession,
        message_service: MessageService,
        create_assistant_text_messages_in_db: None,
        ...
        assert paginated_messages.total_count == 50
        assert paginated_messages.has_more == True
        assert paginated_messages.next_timestamp == to_utc_isostring(
            assistant_text_message_params[9].created_at
        )

    async def test_get_paginated_messages_with_sorted_by_created_at_desc(
        self,
        async_session: AsyncSession,
        message_service: MessageService,
        create_assistant_text_messages_in_db: None,
    ...
    async def test_get_paginated_messages_with_sorted_by_updated_at_desc(
        self,
        async_session: AsyncSession,
        message_service: MessageService,
        create_assistant_text_messages_in_db: None,
    ...
    async def test_get_paginated_messages_with_sorted_by_updated_at_asc(
        self,
        async_session: AsyncSession,
        message_service: MessageService,
        create_assistant_text_messages_in_db: None,
        ...
        assert paginated_messages.has_more == True
        assert paginated_messages.next_timestamp == to_utc_isostring(
            assistant_text_message_params[9].updated_at
        )

    async def test_get_paginated_messages_with_from_timestamp(
        self,
        async_session: AsyncSession,
        message_service: MessageService,
        create_assistant_text_messages_in_db: None,
    ...
    async def test_get_paginated_messages_with_from_timestamp_and_custom_limit(
        self,
        async_session: AsyncSession,
        message_service: MessageService,
        create_assistant_text_messages_in_db: None,
    ...
    async def test_get_paginated_messages_with_from_timestamp_and_custom_limit_and_no_more_messages(
        self,
        async_session: AsyncSession,
        message_service: MessageService,
        create_assistant_text_messages_in_db: None,
    ...
    async def test_get_paginated_messages_with_from_timestamp_and_invalid_limit(
        self,
        async_session: AsyncSession,
        message_service: MessageService,
        create_assistant_text_messages_in_db: None,
