...
const RECIPE_META_ICONS = {
    prep_time: <Clock className="text-primary-dark h-4 w-4" />,
    cook_time: <Flame className="text-primary-dark h-4 w-4" />,
    servings: <Users className="text-primary-dark h-4 w-4" />,
} as const;
