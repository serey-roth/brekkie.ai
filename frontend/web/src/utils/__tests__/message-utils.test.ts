...
const createMessage = (id: string, role: 'user' | 'assistant', content_type: 'text' | 'recipe' | 'tool', text_content: string | null, created_at: string, parent_id?: string | null) => ({
    id,
    role,
    created_at,
    thread_id: '1',
...
describe('groupMessagesByRole   ', () => {
    ...
    it('should group assistant messages with the same parent_id', () => {
        const messages = [
            createMessage('2', 'assistant', 'text', 'Assistant message 1', '2021-01-01T00:00:01Z', '1'),
            createMessage('3', 'assistant', 'text', 'Assistant message 2', '2021-01-01T00:00:02Z', '1'),
        ];
        const groups = groupMessagesByRole(messages);
        expect(groups).toEqual([
            { role: 'assistant', messages: [messages[0], messages[1]] },
        ]);
    });
    ...
    it('should create different groups for assistant messages with different parent_id', () => {
        const messages = [
            createMessage('1', 'user', 'text', 'User message 1', '2021-01-01T00:00:00Z'),
            createMessage('2', 'assistant', 'text', 'Assistant message 1', '2021-01-01T00:00:01Z', '1'),
            createMessage('3', 'assistant', 'text', 'Assistant message 2', '2021-01-01T00:00:02Z', '2'),
        ];
        const groups = groupMessagesByRole(messages);
        expect(groups).toEqual([
            { role: 'user', messages: [messages[0]] },
    ...
    it('should create a new group for assistant messages with no parent_id', () => {
        const messages = [
            createMessage('1', 'user', 'text', 'User message 1', '2021-01-01T00:00:00Z'),
            createMessage('2', 'assistant', 'text', 'Assistant message 1', '2021-01-01T00:00:01Z', '1'),
            createMessage('3', 'assistant', 'text', 'Assistant message 2', '2021-01-01T00:00:02Z', null),
        ];
        const groups = groupMessagesByRole(messages);
        expect(groups).toEqual([
            { role: 'user', messages: [messages[0]] },
    ...
    it('should maintain chronological order of messages within each group', () => {
        const messages = [
            ...
            createMessage('2', 'assistant', 'text', 'Assistant message 1', '2021-01-01T00:00:01Z', '1'),
            createMessage('3', 'assistant', 'text', 'Assistant message 2', '2021-01-01T00:00:02Z', '1'),
            createMessage('4', 'assistant', 'text', 'Assistant message 3', '2021-01-01T00:00:03Z', '1'),
    ...
    it('should handle consecutive user messages', () => {
        const messages = [
            createMessage('1', 'user', 'text', 'User message 1', '2021-01-01T00:00:00Z'),
            createMessage('2', 'user', 'text', 'User message 2', '2021-01-01T00:00:01Z'),
            createMessage('3', 'assistant', 'text', 'Assistant message 1', '2021-01-01T00:00:02Z', '1'),
            createMessage('4', 'assistant', 'text', 'Assistant message 2', '2021-01-01T00:00:03Z', '2'),
            createMessage('5', 'user', 'text', 'User message 3', '2021-01-01T00:00:04Z'),
            createMessage('6', 'assistant', 'text', 'Assistant message 3', '2021-01-01T00:00:05Z', '5'),
        ];
        const groups = groupMessagesByRole(messages);
        expect(groups).toEqual([
            { role: 'user', messages: [messages[0]] },
